      ...
      <section className="bg-white py-20 sm:py-24" aria-labelledby="historic-home-heading">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-start lg:gap-16 lg:px-8">
          <div>
            ...
            <a href="https://www.citystaug.com/1199/Building-Permit-Information" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-2 font-semibold text-amber-900 underline decoration-amber-500 underline-offset-4 hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500">Check the City’s building permit information <ArrowRight className="h-4 w-4" aria-hidden="true" /></a>
          </div>
